...
class AnswerAgent:
    ...
    def generate_answer(
        ...
        user_prompt = (
            ...
            f"5. Обязательно сохраняй оригинальные технические термины, параметры, названия полей и значения на английском языке (например, quality_thresholds, wide_table) БЕЗ перевода и изменений.\n\n"
