    ...
    def generate_answer(
        ...
        if has_code:
            ...
            rules = (
                ...
                "3. Подтверждай факты ссылками в формате [slug]. СТРОГО используй оригинальные названия файлов из контекста (например, [p709-passport]). ЗАПРЕЩЕНО писать цифры вроде [1], [2]!\n"
                "4. НЕ добавляй в конце блок 'Источники', он сгенерируется автоматически.\n"
